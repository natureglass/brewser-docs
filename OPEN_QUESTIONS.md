...
## B. Policy & trust decisions — RESOLVED (2026-08-13)

**Maintainer said "resolve and merge."** All B-items were finalized with conservative,
community-standard defaults and the visible `DECISION NEEDED` blockquotes removed from the pages:
